...
# PARAMÈTRES "DEMO"
# ===============================
TARGET_ROWS = 10_000          # 10 000 lignes max
OUTPUT_FILE = "allergens_demo.csv"

# ===============================
# GÉNÉRATION ALÉATOIRE AVEC UNICITÉ
# ===============================
def generate_big_csv():
    print(f"Génération d'un CSV de démo ({TARGET_ROWS:,} lignes max)…")
    ...
    # Nombre de lignes qu'on va réellement générer
    rows_to_generate = min(TARGET_ROWS, total_combos)
    print(f"Lignes à générer (unique combos) : {rows_to_generate:,}")
    ...
    with open(OUTPUT_FILE, "w", newline='', encoding="utf-8") as f:
        ...
        # On parcourt une partie des combinaisons dans un ordre pseudo-aléatoire
        for step in range(rows_to_generate):
            # Index unique dans [0, total_combos)
